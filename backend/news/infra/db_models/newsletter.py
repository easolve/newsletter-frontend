...
class Newsletters(Base):
    ...
    newsletter_sent: Mapped[List["NewslettersSent"]] = relationship(
        back_populates="newsletters", lazy="selectin"
    )
    topics: Mapped[List["Topics"]] = relationship(
        secondary=newsletter_topic, back_populates="newsletters", lazy="selectin"
    )
    sources: Mapped[List["Sources"]] = relationship(
        secondary=newsletter_source, back_populates="newsletters", lazy="selectin"
    )
...
class Sources(Base):
    ...
    newsletters: Mapped[List["Newsletters"]] = relationship(
        secondary=newsletter_source, back_populates="sources"
    )
...
class Topics(Base):
    ...
    newsletters: Mapped[List["Newsletters"]] = relationship(
        secondary=newsletter_topic, back_populates="topics"
    )
